...
internal sealed class OnBoardConnectSideEffect: SideEffect<Context>() {
    ...
    class CopyBackupToClipboard(private val keys: String): OnBoardConnectSideEffect() {
        override suspend fun execute(value: Context) {
    ...
    object GithubPATSuccessfullySet: OnBoardConnectSideEffect() {
        override suspend fun execute(value: Context) {
            SphinxToastUtils(true).show(value, R.string.github_pat_succeed)
        }
    }

    object FailedToSetGithubPat: OnBoardConnectSideEffect() {
        override suspend fun execute(value: Context) {
