...
@Suppress("ClassName")
sealed class ChatTribeActionsMenuViewState: MotionLayoutViewState<ChatTribeActionsMenuViewState>() {

    object Closed: ChatTribeActionsMenuViewState() {
    ...
    object Open: ChatTribeActionsMenuViewState() {
        override val startSetId: Int
            get() = R.id.motion_scene_chat_menu_closed
        override val endSetId: Int
            get() = R.id.motion_scene_chat_menu_open
