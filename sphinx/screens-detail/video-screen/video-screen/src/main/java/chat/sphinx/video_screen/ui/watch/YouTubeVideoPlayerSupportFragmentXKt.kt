...
open class YouTubeVideoPlayerSupportFragmentXKt : Fragment(), YouTubePlayer.Provider {
    ...
    companion object {
        fun newInstance(): YouTubeVideoPlayerSupportFragmentXKt {
            return YouTubeVideoPlayerSupportFragmentXKt()
        }
    }
