...
internal sealed class PodcastPlayerSideEffect: SideEffect<Context>() {

    sealed class Notify: PodcastPlayerSideEffect() {
        ...
        object BoostSent : Notify() {
            override val stringRes: Int
                get() = R.string.boost_sent
        }
    }
}