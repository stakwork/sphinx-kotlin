...
import chat.sphinx.payment_common.navigation.ToPaymentSendDetail
...
internal inline val PaymentFragmentArgs.chatId: ChatId?
...
internal inline val PaymentFragmentArgs.contactId: ContactId?
        ...
        PaymentSendViewState>(dispatchers, PaymentSendViewState.Idle)
{
    ...
    private val args: PaymentFragmentArgs by savedStateHandle.navArgs()
