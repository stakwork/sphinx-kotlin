    ...
    ): SignerManager(), CoroutineScope
{
    ...
    override fun connectToMQTTWith(keys: Keys, password: String) {
    ...
    override fun processMessage(topic: String, payload: ByteArray, mqttClient: MqttClient) {
        launch {
    ...
    override suspend fun argsAndState(): Pair<String, ByteArray> {
        val args = makeArgs()
    ...
    override fun restart(mqttClient: MqttClient) {
    ...
    override fun storeMutations(inc: ByteArray) {
        launch {
            try {
    ...
    override suspend fun makeArgs(): Map<String, Any>? {
    ...
    override fun retrieveOrGenerateClientId(): String {
    ...
    override fun retrieveOrGenerateLssNonce(): List<Int> {
    ...
    override fun storeMutationsOnSharedPreferences(newMutations: MutableMap<String, ByteArray>) {
    ...
    override fun retrieveMutations(): MutableMap<String, ByteArray> {
    ...
    override fun storeAndIncrementSequence(sequence: UShort) {
    ...
    override fun retrieveSequence(): UShort {
    ...
    override fun encodeMapToBase64(map: MutableMap<String, ByteArray>): String {
    ...
    override fun decodeBase64ToMap(encodedString: String): MutableMap<String, ByteArray> {
    ...
    override fun argsToJson(map: Map<String, Any>?): String? {
        val adapter = moshi.adapter(Map::class.java)
        return adapter.toJson(map)
    }

    override fun generateRandomBytes(): UByteArray {
    ...
    override suspend fun generateAndPersistMnemonic() : Pair<String?, WalletMnemonic?> {
