...
internal class ActionTrackDboContentConsumedPresenterMapper(
    dispatchers: CoroutineDispatchers,
    val moshi: Moshi
): ClassMapper<ActionTrackDbo, ContentConsumedAction?>(dispatchers) {

    override suspend fun mapFrom(value: ActionTrackDbo): ContentConsumedAction? {
        return value.meta_data.value.toContentConsumedActionOrNull(moshi)
    }

    override suspend fun mapTo(value: ContentConsumedAction?): ActionTrackDbo {
