...
//        private const val DEFAULT_SERVER_URL = "http://192.168.0.25:8000"
    ...
    override fun sendEncryptedSeed(
        ...
        networkRelayCall.post(
            url = String.format(ENDPOINT_POST_ENCRYPTED_SEED, "{\"seed\":\"${seedDto.seed}\",\"ssid\":\"${seedDto.ssid}\",\"pass\":\"${seedDto.pass}\",\"broker\":\"${seedDto.lightningNodeUrl}:${seedDto.lightningNodePort}\",\"pubkey\":\"${seedDto.pubkey}\",\"network\":\"${seedDto.network}\"}"),
